...
function preguntarOtraVez() {
    ...
    if(otroProducto == "si"){
        ...
        const mostrarCarrito = document.createElement("h3");
        mostrarCarrito.setAttribute("class","h3");
        mostrarCarrito.textContent = "Tu carrito:";
        document.getElementById("carrito").appendChild(mostrarCarrito);

        const mostrarProductos = document.createElement("p");
        mostrarProductos.setAttribute("class","p");
        mostrarProductos.textContent = `Elementos en tu carrito de compras: ${carroDeCompras} `;
        document.getElementById("carrito").appendChild(mostrarProductos);

        const mostrarTotal = document.createElement("p");
        mostrarTotal.setAttribute("class","p");
        mostrarTotal.textContent = `Total a abonar: ${carrito} pesos.`;
        document.getElementById("carrito").appendChild(mostrarTotal);
